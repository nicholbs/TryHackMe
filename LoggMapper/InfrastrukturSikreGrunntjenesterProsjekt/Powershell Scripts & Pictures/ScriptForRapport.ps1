...
$services = Get-Service | Group-Object StartType | Sort-object Name	
						#Data for formatering, nemlig alle tjenester gruppert i start type 										#I tillegg sorter dem etter navn
...
ConvertTo-Html -Title 'Services' -Body $html | Out-File .\RapportAvTjenester.html	
						#Lag html siden med tittel services
						#Kroppen av rapport er array $html
						#Skriv rapporten til fil RapportAvTjenester.html 

start .\RapportAvTjenester.html			#Åpne rapport i nettleser